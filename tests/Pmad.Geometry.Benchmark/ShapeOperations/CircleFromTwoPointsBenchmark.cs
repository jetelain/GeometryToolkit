...
namespace Pmad.Geometry.Benchmark.ShapeOperations
{
    public class CircleFromTwoPointsBenchmark
    {
        ...
        [Benchmark] public void FromTwoPoints_2D_StaticOperators() => SampleValuesRO.RandomPairList2D.ForEach(p => Circle<double, Vector2D>.FromTwoPoints_StaticOperators(ShapeSettings<double, Vector2D>.Default, p.Item1, p.Item2));
        ...
        [Benchmark] public void FromTwoPoints_2F_StaticOperators() => SampleValuesRO.RandomPairList2F.ForEach(p => Circle<float, Vector2F>.FromTwoPoints_StaticOperators(ShapeSettings<float, Vector2F>.Default, p.Item1, p.Item2));
