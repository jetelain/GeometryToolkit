...
namespace Pmad.Geometry.Benchmark.ShapeOperations
{
    public class CircleFromThreePointsBenchmark
    {
        ...
        [Benchmark] public void FromThreePoints_2D_StaticOperators() => SampleValuesRO.RandomTripletList2D.ForEach(p => Circle<double, Vector2D>.FromThreePoints_StaticOperators(ShapeSettings<double, Vector2D>.Default, p.Item1, p.Item2, p.Item3));
        ...
        [Benchmark] public void FromThreePoints_2F_StaticOperators() => SampleValuesRO.RandomTripletList2F.ForEach(p => Circle<float, Vector2F>.FromThreePoints_StaticOperators(ShapeSettings<float, Vector2F>.Default, p.Item1, p.Item2, p.Item3));
    }
}
