...
{
    internal struct MultiplyTransform<TPrimitive, TVector> : ITransform<TVector>, ITransformVect<TPrimitive, TVector>
        where TPrimitive : unmanaged, INumber<TPrimitive>
        where TVector : struct, IVector2<TPrimitive, TVector>
    {
        internal readonly TPrimitive _primitive;

        public MultiplyTransform(TPrimitive primitive)
        {
        ...
        {
            TransformVectHelper<TPrimitive, TVector, MultiplyTransform<TPrimitive, TVector>>.Transform(this, source, destination);
        }
