...
namespace Pmad.Geometry.Algorithms
{
	public static class PointInPolygon
	{
        ...
        public static PointInPolygonResult TestPointInPolygon(this List<Vector2IS> polygon, Vector2IS pt)
        {           
        ...
        public static PointInPolygonResult TestPointInPolygon(this List<Vector2FS> polygon, Vector2FS pt)
        {           
        ...
        public static PointInPolygonResult TestPointInPolygon(this List<Vector2LS> polygon, Vector2LS pt)
        {           
        ...
        public static PointInPolygonResult TestPointInPolygon(this List<Vector2DS> polygon, Vector2DS pt)
        {           
        ...
        public static PointInPolygonResult TestPointInPolygon(this List<Vector2FN> polygon, Vector2FN pt)
        {           
        ...
        {
            if (polygon is List<Vector2FN> list)
            {
                return TestPointInPolygon(list, pt);
            }
            return TestPointInPolygonImpl(polygon, pt);
        ...
        private static PointInPolygonResult TestPointInPolygonImpl(IReadOnlyList<Vector2FN> polygon, Vector2FN pt)
        {                
            int len = polygon.Count, start = 0;
            if (len < 3) return PointInPolygonResult.IsOutside;
            ...
            if (isAbove != startingAbove)
            {
                if (i == len) i = 0;
                if (i == 0)
                    d = Vector2FN.CrossProduct(polygon[len - 1], polygon[0], pt);
                else
