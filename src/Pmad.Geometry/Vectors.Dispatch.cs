...
namespace Pmad.Geometry
{
    public static partial class Vectors
    {
            ...
            where TVector : struct, IVector<TVector>
        {
            if (typeof(TVector) == typeof(Vector2I))
            {
                return Vector2I.CrossProduct((Vector2I)(object)left,(Vector2I)(object)right);
            }
            if (typeof(TVector) == typeof(Vector2F))
            {
                return Vector2F.CrossProduct((Vector2F)(object)left,(Vector2F)(object)right);
            }
            if (typeof(TVector) == typeof(Vector2L))
            {
                return Vector2L.CrossProduct((Vector2L)(object)left,(Vector2L)(object)right);
            }
            if (typeof(TVector) == typeof(Vector2D))
            {
                return Vector2D.CrossProduct((Vector2D)(object)left,(Vector2D)(object)right);
            }
            if (typeof(TVector) == typeof(Vector2IS))
            {
                return Vector2IS.CrossProduct((Vector2IS)(object)left,(Vector2IS)(object)right);
            }
            if (typeof(TVector) == typeof(Vector2FS))
            {
                return Vector2FS.CrossProduct((Vector2FS)(object)left,(Vector2FS)(object)right);
            }
            if (typeof(TVector) == typeof(Vector2LS))
            {
                return Vector2LS.CrossProduct((Vector2LS)(object)left,(Vector2LS)(object)right);
            }
            if (typeof(TVector) == typeof(Vector2DS))
            {
                return Vector2DS.CrossProduct((Vector2DS)(object)left,(Vector2DS)(object)right);
            }
            if (typeof(TVector) == typeof(Vector2FN))
            {
                return Vector2FN.CrossProduct((Vector2FN)(object)left,(Vector2FN)(object)right);
            }
            ThrowHelper.ThrowNotSupportedException();
            return default;
        }
